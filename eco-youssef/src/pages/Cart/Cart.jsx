    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10 text-right" dir="rtl">
            <div className="mx-auto max-w-5xl px-4">
                <div className="mb-6 flex items-center justify-between"><h1 className="text-3xl font-black text-gray-900">سلة التسوق</h1><button type="button" onClick={clearCart} className="font-bold text-red-600">إفراغ السلة</button></div>
